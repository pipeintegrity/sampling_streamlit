...
if module == "T-Test":
    ...
    st.html("""
        <div style="background-color: #FFFBEB; border-left: 4px solid #F59E0B; padding: 20px; border-radius: 0 12px 12px 0; margin-top: 20px;">
            <div style="display: flex; align-items: center; gap: 8px; color: #78350F; font-weight: bold; margin-bottom: 12px;">
                <span>ℹ️</span> <strong>Understanding Chi-Square Tests</strong>
            </div>
